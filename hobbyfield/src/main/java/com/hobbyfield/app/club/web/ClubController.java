...
public class ClubController {
   ...
   public String clubList(Model model) {
      model.addAttribute("clubList", clubService.getCreateClubList());
   ...
   public String clubInsertProcess(ClubVO clubVO) {
   ...
   public String nickChkPOST(String profileNickname) throws Exception{
      ...
      int result = clubService.nickChk(profileNickname);
   ...
   public String clubnameChkPOST(String clubName) throws Exception {
      ...
      int result = clubService.clubnameChk(clubName);
