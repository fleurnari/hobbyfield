...
<body>
	<div align="center" class="profile_top">
		...
		<div>
			<a href="${pageContext.request.contextPath}/club/profileList">프로필
				조회</a>
		</div>
		<br>

		<form action="profileInsert" method="post" id="join_form" enctype="enctype=multipart/form-data">
			...
			<div>
				<label>이메일 : ${member.memberEmail}</label><br> <input
					type="hidden" value="${member.memberEmail}" name="memberEmail">
			</div>

			<div class="profileSection">
				<label>첨부이미지</label>
				<div id="preview"></div>
				<input id="imgFile" name="uploadFile" type="file" value="profileImg"
					onchange="readURL(this);">
				<button type="button" id="uploadBtn">upload</button>
			</div>
			<div class="join_button_wrap">
				<button type="button" class="join_button">등록하기</button>
			</div>
