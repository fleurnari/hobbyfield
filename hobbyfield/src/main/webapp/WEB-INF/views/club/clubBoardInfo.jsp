...
<body>
               ...
               <div class="tab-content" id="emojis">
                  <c:if test="${not empty emojis}">
                     <c:forEach items="${emojis}" var="emoji" varStatus="status">
                        <img src="${pageContext.request.contextPath}${emoji.emojiImgPath}${emoji.emojiImgName}"
   ...
   <div class="modal updateModal">
         <div class="modal_content">
           <div class="m_head">
               <div class="modal_title"><h3>댓글</h3></div>
         ...
         <div>
            <label for="profileNickname">댓글 작성자 : ${profile.profileNickname} </label>
            <br>
            <label for="updateClubCommentContent">댓글 내용</label>
               <textarea rows="1" cols="100" id="updateClubCommentContent" name="clubCommentContent"></textarea>
            <br>
            <label for="updateClubCommentSecret">비밀 댓글 <input type="checkbox" id="updateClubCommentSecret" name="clubCommentSecret" value=""></label>
         </div>
      <div>
             ...
             <div class="m_footer">
               <button type="button" id="commentUpdate" class="btn btn-primary btn-outline btn-lg update_btn">댓글 수정</button>&nbsp;&nbsp;
         <button type="button" class="btn btn-primary btn-outline btn-lg close_btn">취소</button>&nbsp;&nbsp;
          </div>
        </div>
   </div>
   ...
   <!-- 대댓 작성 모달 -->
	...
	<div id="" class="c"> 
		<form id="clubRecommentInsert">
			...
			<div>
				<label for="profileNickname"> 댓글 작성자 </label><input type="text" id="recommentProfileNickname" name="profileNickname" value="${profile.profileNickname}"/>
				<br>
				<label for="recommentClubCommentContent">댓글 내용</label>
				<div id="editor2">1515</div>
				<br>
				<label for="recommentClubCommentSecret">비밀 댓글</label>
				<input type="checkbox" id="recommentClubCommentSecret" name="clubCommentSecret" value="">
			</div>
			<div>
				<button type="button" id="recommentInsertBtn" class="btn btn-primary btn-outline btn-lg">작성</button>&nbsp;&nbsp;
				<button type="button" onclick="closeModal()" class="btn btn-primary btn-outline btn-lg">취소</button>&nbsp;&nbsp;
			</div>
		</form>
	</div>
	</div>
