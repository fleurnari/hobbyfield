		...
		<div>
			<form method="post">
				...
				<div>
					...
					<input type="text" id="clubBoardWdate"
	...
	<div class="comment">
		...
		<!-- 댓글 작성용 1.댓글작성, 2. 사진포함 댓글작성 -->
			...
			<form id="commentInsertForm">
				<input type="hidden" id="boardNumber" name="boardNumber"	value="${board.boardNumber}"> <label for="profileNickname">댓글
					작성자 : </label> <input type="text" id="profileNickname"	 name="profileNickname" value="${profile.profileNickname}" readonly>
