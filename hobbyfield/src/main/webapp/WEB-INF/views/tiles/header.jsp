...
<link
	href="${pageContext.request.contextPath}/resources/css/theme.css?after"
	rel="stylesheet">
	...
	<nav class="class=" navbar bg-primary" data-bs-theme="dark"">
		<div class="container">
			<ul class="nav justify-content-end">
				<a class="navbar-brand" href="${pageContext.request.contextPath}/" style="float: left;"> 
					<img src="${pageContext.request.contextPath}/resources/images/logo2.png" alt="Bootstrap" width="200" class="float-left">
				</a>
				<li class="nav-item"><a class="nav-link fw-bold"
					href="${pageContext.request.contextPath}/club/clubMain">소모임</a></li>
				<li class="nav-item"><a class="nav-link fw-bold"
					href="${pageContext.request.contextPath }/prdt/prdtList">쇼핑몰</a></li>
				<li class="nav-item"><a class="nav-link fw-bold"
				...
				<li><c:if test="${member == null}">
						...
						<div class="ms-lg-5">
							<img
								src="${pageContext.request.contextPath}/resources/img/push.png"
								width="30px" onclick="pushList()" style="position: relative;">
							<div id="nemo" style="position: absolute; top: 0px;"></div>
							<span>${member.memberNm} 님 환영합니다.</span> <a
								class="nav-link fw-bold"
								href="${pageContext.request.contextPath}/member/myPage">My
								Page</a>
							<c:if test="${member.memberGrd eq 'A3'}">
								<a href="${pageContext.request.contextPath}/admin/memberList">관리자
									페이지</a>
							</c:if>
