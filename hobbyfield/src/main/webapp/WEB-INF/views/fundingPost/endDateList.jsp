 ...
 <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <div class="container2">
     ...
     <c:forEach items="${endDateList}" var="endDateList">
     <c:if test="${endDateList.fndStatus eq '2' }">
        <div class="col" onclick="location.href='fundingPostInfo?fndPostNumber=${endDateList.fndPostNumber }'">
...
<svg class="bd-placeholder-img card-img-top" width="337.78" height="225" role="img" aria-label="Placeholder: Thumbnail" focusable="false">
  ...
  <image xlink:href="${pageContext.request.contextPath}${endDateList.fndMainImgPath}${endDateList.fndMainImg}" width="337.78" height="225" />
</svg>
            <div class="card-body">
              <p class="card-text">
              <p>
					<span>${endDateList.fndCategory }</span><span> | </span><span>${ParticipantsList.memberEmail }</span>
				</p>
				<p>
					<span><h3>${endDateList.fndTitle }</h3></span>
				</p>
				<p>
					<span><div class="progress">
    <div class="progress-bar" role="progressbar" style="width: ${(endDateList.fndCurrentAmount / endDateList.fndTargetAmount) * 100}%;" aria-valuenow="${(fundingPost.fndCurrentAmount / fundingPost.fndTargetAmount) * 100}" aria-valuemin="0" aria-valuemax="100">${(fundingPost.fndCurrentAmount / fundingPost.fndTargetAmount) * 100}% 진행중</div>
</div><span>        조회수: ${endDateList.fndViews }</span>
				</p>
				<p>
					<span>${endDateList.fndCurrentAmount }</span><span>원</span>
				</p>
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="text-body-secondary">					<span>펀딩 마감까지 남은 시간</span>
					<span class="time">
    					...
    					<fmt:parseDate value="${endDateList.fndEndDate}"  pattern="yyyy-MM-dd" var="endPlanDate"/>
