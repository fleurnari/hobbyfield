	...
	<section class="bg-100 py-7" id="packages">
       <div class="container-lg">
         <div class="row justify-content-center">
           <div class="col-12">
             <h1 class="text-center lh-sm fs-lg-6 fs-xxl-7">나의 좋아요</h1>
           </div>
         </div>
         <div id="box">
         	<div>
				...
				<table>
					...
					<tbody>
						<c:forEach items="${likeList}" var="like">
							<tr onclick="location.href='${pageContext.request.contextPath}/club/clubBoardInfo?boardNumber=${like.boardNumber}'">
								<td>${like.clubBoardContent}</td>
								<td><fmt:formatDate value="${like.clubBoardWdate}"
