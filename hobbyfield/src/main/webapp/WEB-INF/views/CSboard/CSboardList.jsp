...
<body>
 <div id="wrapper">
                        ...
                        <table>
                            <tbody>
                              	<c:forEach items="${CSboardList }" var="CSboard">
									<tr onclick="location.href='CSboardInfo?csNumber=${CSboard.csNumber}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'">
		...
		<div align="center">
			<button type="button" class="btnList" onclick="location.href='CSboardInsert'">게시글등록</button>
						...
						<div>
							<ul>
								...
								<c:forEach begin="${pageMaker.startPage}"
									...
									<li><a href="${pageContext.request.contextPath }/CSboard/CSboardList${pageMaker.makeSearch(idx)}">${idx}</a></li>
								</c:forEach>
